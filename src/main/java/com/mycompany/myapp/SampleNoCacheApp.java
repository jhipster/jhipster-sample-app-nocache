...
public class SampleNoCacheApp {

    private static final Logger log = LoggerFactory.getLogger(SampleNoCacheApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes sampleNoCache.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SampleNoCacheApp.class);
