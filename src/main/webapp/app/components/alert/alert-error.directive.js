(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('jhipsterNoCacheSampleApplicationApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-jhipsterNoCacheSampleApplicationApp-error');
                var entityKey = httpResponse.headers('X-jhipsterNoCacheSampleApplicationApp-params');
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('jhipsterNoCacheSampleApplicationApp.' + fieldError.objectName + '.' + convertedField);
