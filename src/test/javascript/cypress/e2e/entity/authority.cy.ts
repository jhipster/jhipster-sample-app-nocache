...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0a9f9874-8ef9-4ebb-9b0e-565f6da0cee1' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('99b39933-b431-47bd-96b2-79ec55c4a2f3');
      cy.get(`[data-cy="name"]`).should('have.value', '99b39933-b431-47bd-96b2-79ec55c4a2f3');
