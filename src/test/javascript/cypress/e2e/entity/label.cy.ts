...
describe('Label e2e test', () => {
  ...
  const labelSample = { label: 'aggregate Future' };
  ...
  describe('new Label page', () => {
    ...
    it('should create an instance of Label', () => {
      cy.get(`[data-cy="label"]`).type('Demigender Factors Hybrid');
      cy.get(`[data-cy="label"]`).should('have.value', 'Demigender Factors Hybrid');
