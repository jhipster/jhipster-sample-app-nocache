...
describe('Label e2e test', () => {
  ...
  const labelSample = { label: 'Maserati eyeballs' };
  ...
  describe('new Label page', () => {
    ...
    it('should create an instance of Label', () => {
      cy.get(`[data-cy="label"]`).type('supposing Metal trance');
      cy.get(`[data-cy="label"]`).should('have.value', 'supposing Metal trance');
