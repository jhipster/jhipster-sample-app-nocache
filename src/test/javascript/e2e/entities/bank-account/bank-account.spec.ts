...
describe('BankAccount e2e test', () => {
    ...
    it('should load BankAccounts', () => {
        ...
        expect(bankAccountComponentsPage.getTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.bankAccount.home.title/);
    });
    ...
    it('should load create BankAccount page', () => {
        ...
        expect(bankAccountUpdatePage.getPageTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.bankAccount.home.createOrEditLabel/);
