...
describe('BankAccount e2e test', () => {
    ...
    it('should load BankAccounts', async () => {
        ...
        expect(await bankAccountComponentsPage.getTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.bankAccount.home.title/);
    });
    ...
    it('should load create BankAccount page', async () => {
        ...
        expect(await bankAccountUpdatePage.getPageTitle()).toMatch(
            /jhipsterNoCacheSampleApplicationApp.bankAccount.home.createOrEditLabel/
        );
