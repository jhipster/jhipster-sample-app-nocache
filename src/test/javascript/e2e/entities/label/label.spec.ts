...
describe('Label e2e test', () => {
  ...
  it('should load Labels', () => {
    ...
    expect(labelComponentsPage.getTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.label.home.title/);
  });

  it('should load create Label page', () => {
    labelComponentsPage.clickOnCreateButton();
    labelUpdatePage = new LabelUpdatePage();
    expect(labelUpdatePage.getPageTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.label.home.createOrEditLabel/);
