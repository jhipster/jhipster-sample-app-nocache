...
describe('Operation e2e test', () => {
    ...
    it('should load Operations', async () => {
        ...
        expect(await operationComponentsPage.getTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.operation.home.title/);
    });
    ...
    it('should load create Operation page', async () => {
        ...
        expect(await operationUpdatePage.getPageTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.operation.home.createOrEditLabel/);
