...
describe('Operation e2e test', () => {
    ...
    it('should load Operations', () => {
        ...
        expect(operationComponentsPage.getTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.operation.home.title/);
    });
    ...
    it('should load create Operation page', () => {
        ...
        expect(operationUpdatePage.getPageTitle()).toMatch(/jhipsterNoCacheSampleApplicationApp.operation.home.createOrEditLabel/);
